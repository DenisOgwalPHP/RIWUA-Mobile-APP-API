...
$providers=$_GET['providerid'];
 include('DB_Connect.php');
  ...
  //creating a query
 $stmt =$connect_db->prepare("SELECT providerid, ProviderName,Contact,Email,ImageURL,TimeRegistered,Services,Description FROM ServiceProviders where providerid='".$providers."' order by providerid DESC;");
